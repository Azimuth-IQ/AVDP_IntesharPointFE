  ...
  runZonedGuarded(
    () async {
      ...
      PlatformDispatcher.instance.onError = (Object error, StackTrace stack) {
        ClientLogReporter.report(message: error.toString(), errorType: error.runtimeType.toString(), stack: stack.toString(), action: 'PlatformDispatcher');
        return true;
      };
    ...
    (Object error, StackTrace stack) {
      ClientLogReporter.report(message: error.toString(), errorType: error.runtimeType.toString(), stack: stack.toString(), action: 'uncaughtZone');
    },
  );
}
